...
/*
 * Returning values instead of printing inside the function makes it more reusable
 * because the caller decides what to do with the result—whether to print it,
 * save it to a database, or use it in further logic.
 */
...
console.log(getOrderMessage()); // Call relying on default parameter value
...
repeat(() => console.log("Hello!"), 3); // Example usage of repeat with an arrow function
...
// console.log(insideIf); // prediction first, then uncomment to verify: not defined  Actual: ReferenceError: insideIf is not defined
